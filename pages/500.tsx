...
const error500 = () => {
  return (
    <div className={style.main_error_page}>
      <Head>
        <title>500 - Woops! Something went wrong :(</title>
      </Head>
      <svg
      ...
      <h2 className={style.error_subtitle}>
