...
const ProfileManu = () => {
  ...
  return (
    <Menu as="div" className="ml-3 relative">
      ...
      >
        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-slate-800 text-white ring-1 ring-black ring-opacity-5 focus:outline-none">
